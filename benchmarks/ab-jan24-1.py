#!/usr/bin/env python3
# Client has all options enabled.
...
import nic_of_time.result_parsers.perf
...
opts.retry = 4
opts.nodes = [nt.Node('s-h0',internal_address="10.53.1.33",is_server=True,
                      explore_options=True),
              nt.Node('s-h1',internal_address="10.53.1.20",
...
exp_opts = {}
opts.plot_dir = "ab-jan24-1/plot"
for tag, cmd in exps:
    opts.nodes[1].commands = [cmd]
    prefix = "ab-jan24-1/"+tag
