#!/usr/bin/env python3
# Client has all options disabled.
...
opts.retry = 4
opts.nodes = [nt.Node('s-h4',internal_address="10.53.1.19",is_server=True,
                      explore_options=True),
              nt.Node('s-h5',internal_address="10.53.1.1",
...
exp_opts = {}
opts.plot_dir = "ab-jan24-2/plot"
for tag, cmd in exps:
    opts.nodes[1].commands = [cmd]
    prefix = "ab-jan24-2/"+tag
